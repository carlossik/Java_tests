...
public class ProteusWebAdvertiserAccountsPage extends BrowserFactory {
    ...
    @CacheLookup
    public WebElement rowAdvertiser;
    ...
    public boolean CheckForMergeObjectsOnDialog(){
        boolean returnType =
                txtMergeAdvertiser.isDisplayed() &&
